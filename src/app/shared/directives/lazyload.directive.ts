  ...
  @Input() public preRender: boolean = true;
    ...
    private registerIntersectionObserver (): void {
        ...
        this._intersectionObserver = new IntersectionObserver(entries => {
              console.log("[LazyLoad] registerIntersectionObserver");       //DEBUGGING
    ...
    private checkForIntersection = (entries: Array<IntersectionObserverEntry>) => {
        entries.forEach((entry: IntersectionObserverEntry) => {
            console.log("[LazyLoad] checkIfIntersection");  //DEBUGGING
    ...
    private checkIfIntersecting (entry: IntersectionObserverEntry) {
        ...
        console.log("[LazyLoad] checkIfIntersecting");  //DEBUGGING
    ...
    private load (): void {
        console.log("[LazyLoad] load"); //DEBUGGING
        this.removeListeners();
