...
/*
  ...
  <div style='width: 1080px; height: 1920px;'> 
    <div parallax speed='10' src='/assets/imgs/parallax.jpg' ></div> 
...
@Input('speed') speed:any;
  ...
  ngOnInit(){
    ...
    var fastTextElement = t.element;
        fastTextElement.style.backgroundRepeat = "repeat";
        fastTextElement.style.backgroundAttachment = "fixed";
        fastTextElement.style.width = "100%";
        fastTextElement.style.height = "100%";
        fastTextElement.style.margin = "0 auto"
        fastTextElement.style.position = "relative"
        fastTextElement.style.background = "url(" + _img + ")"
        fastTextElement.style.backgroundAttachment = 'fixed';
